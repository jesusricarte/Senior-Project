...
void selectlvl(void){
HIDE_BKG;
set_bkg_data(0,31, lvlselect_data);
...
while(n < 2)
{
 ...
 move_sprite(1,menusprite2[0],menusprite2[1]); //second ghost in lvl select
    ...
    if((menusprite[1] == 20) && (joypad() & J_START))
        {
           //printf("LEVEL 1\n");
            n = 2;
            levelselected = 1;
        }
        else  if((menusprite[1] == 44) && (joypad() & J_START))
        {
           //printf("LEVEL 2\n");
            n = 2;
            levelselected = 2;
        }
          else  if((menusprite[1] == 68) && (joypad() & J_START))
        {
          ...
          else  if((menusprite[1] == 92) && (joypad() & J_START))
        {
          ...
          else  if((menusprite[1] == 116) && (joypad() & J_START))
        {
           ...
           else  if((menusprite[1] == 140) && (joypad() & J_START))
        {
